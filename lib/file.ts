...
export default class {
    ...
    public static async serve(req: requestctx, res: responsectx, pathname: string, cwd: string = ".", index: string = 'index.html') {
    ...
    private static async target(pathname: string, cwd: string = '.', index: string = 'index.html') {
